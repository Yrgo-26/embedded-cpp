/**
 * @file Tests for Övningsset 3: swap, in an anonymous namespace in exercise3/main.cpp.
 *
 ...
 */
[[nodiscard]] constexpr std::uint32_t swappedAtCompileTime() noexcept
{
...
/**
 * @brief Övning 3.1: the two variables exchange values.
 */
...
/**
 * @brief Övning 3.1: swapping twice restores the originals, and equal values stay equal.
 */
...
/**
 * @brief Övning 3.1: swap() is constexpr and noexcept, as its declaration says.
 */
...
#ifdef PROGRAM
/**
 * @brief Övning 3.1: the program prints the example output, and ends normally.
 */
