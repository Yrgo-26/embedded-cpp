/**
 * @file Tests for Övningsset 1: debug::log and app::delay_ms, in exercise1/main.cpp.
 *
...
/**
 * @brief Övning 1.1: the message is printed with its log level, as in the example output.
 */
...
/**
 * @brief Övning 1.1: leaving the level out logs at level 0.
 */
...
/**
 * @brief Övning 1.1: debug::log is marked noexcept.
 */
TEST(Logger, IsNoexcept) { EXPECT_TRUE(noexcept(debug::log("message"))); }

/**
 * @brief Övning 1.2: app::delay_ms is marked noexcept, defaults to 1 ms, and returns.
 */
