/**
 * @file The suite's always-on tests: claims §3.1 and §3.2 make about inheritance and
 *       interfaces, checked.
 *
...
/** A base class with protected members, as driver::Gpio has in §3.1. */
class Base
{
public:
...
/** An interface: pure virtual methods and a virtual destructor, as in §3.2. */
class Interface
{
public:
