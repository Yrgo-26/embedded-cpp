/**
 * @file Tests for Övningsset 2: driver::factory::Interface, driver::factory::Esp32s3 and
...
/**
 * @brief Övning 2.1 a): the factory interface is abstract, and its destructor is virtual and
 *        noexcept.
 */
...
/**
 * @brief Övning 2.1 b): serial() takes two pins and returns a raw pointer to the serial
 *        interface, noexcept.
 */
...
/**
 * @brief Övning 2.2: the ESP32-S3 factory is a final implementation of the factory interface,
...
/**
 * @brief Övning 2.2 b): serial() creates an ESP32-S3 serial driver with the pins it was given,
...
/**
 * @brief Övning 2.2 b): every call creates a new driver.
 */
...
/**
 * @brief Övning 2.3: the stub factory is a final implementation of the factory interface,
 *        default constructible, noexcept, and neither copyable nor movable.
 */
...
/**
 * @brief Övning 2.3 b): serial() ignores the pins and creates a working stub serial driver,
