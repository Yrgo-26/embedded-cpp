/**
 * @file Tests for Övningsset 3: app::logic::Logic with a raw-pointer factory, in
...
/**
 * @brief Övning 3.1 b): the constructor asks the factory for one serial driver, with the
 *        pins it was given.
 */
...
/**
 * @brief Övning 3.1 c): Logic owns the driver, and its destructor deletes it exactly once:
...
/**
 * @brief Övning 3.1 b): the constructor is noexcept; e) there is no default constructor, and
...
/**
 * @brief Övning 3.1 d): run() sends 0, 1, 2, ... and tries to read after every write, about
...
/**
 * @brief Övning 3.1 d): run() prints a received byte, and prints nothing when nothing was
 *        received.
 */
...
/**
 * @brief Övning 3.2: main.cpp compiles against your headers. What it does when it runs, you
