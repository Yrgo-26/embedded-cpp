...
public:
     ...
     */
    [[nodiscard]] virtual std::unique_ptr<serial::Interface> serial() noexcept = 0;
     ...
     */
    [[nodiscard]] virtual std::unique_ptr<timer::Interface>
    timer(std::uint16_t timeout_ms) noexcept = 0;
};
} // namespace driver::factory
